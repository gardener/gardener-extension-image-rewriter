...
func (in *ContainerdConfiguration) DeepCopyInto(out *ContainerdConfiguration) {
	*out = *in
	if in.Provision != nil {
		...
		*out = make([]ContainerdUpstreamConfig, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ContainerdUpstreamConfig) DeepCopyInto(out *ContainerdUpstreamConfig) {
	*out = *in
	if in.Hosts != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ContainerdUpstreamConfig.
func (in *ContainerdUpstreamConfig) DeepCopy() *ContainerdUpstreamConfig {
	if in == nil {
		return nil
	}
	out := new(ContainerdUpstreamConfig)
	in.DeepCopyInto(out)
	return out
}
