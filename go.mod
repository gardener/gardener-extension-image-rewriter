...
replace github.com/gardener/gardener => github.com/gardener/gardener v1.73.1-0.20250925193637-cd64534fe09a

require (
	cel.dev/expr v0.24.0 // indirect
	cloud.google.com/go/compute/metadata v0.7.0 // indirect; indirectg
